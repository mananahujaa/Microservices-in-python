...
def FormErrors(*args): #default fucntion to use for AJAX form errors
	'''
...
def reCAPTCHAValidation(token):#API CALL TO reCaptcha
...
def RedirectParams(**kwargs):
	...
	return response
#gives out a parameter string appended to your url like ?color=blue
